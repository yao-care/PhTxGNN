#!/usr/bin/env python3
"""
Generate individual drug pages for PhTxGNN Jekyll site.
...
def main():
    ...
    drug_kg_stats = (
        ...
        .agg(
            kg_predictions=("potential_indication", "count"),
            top_diseases=("potential_indication", lambda x: list(x.head(10))),
        )
        .reset_index()
    )
