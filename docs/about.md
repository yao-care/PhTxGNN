...
nav_order: 90
permalink: /about/
description: "PhTxGNN is a drug repurposing prediction platform developed by 藥提醒科技有限公司 (yao.care), built on the Harvard TxGNN model, covering FDA Philippines-approved medicines in the Philippines."
---
...
<p class="key-answer" data-question="What is PhTxGNN?">
<strong>PhTxGNN</strong> is a research-support platform for drug repurposing, built on the TxGNN
model published in <em>Nature Medicine</em> by the Zitnik Lab at Harvard University. It predicts
indication expansion for medicines approved by FDA Philippines in the Philippines. Beyond AI prediction scores,
...
<tr><td>Registration data</td><td><a href="https://www.fda.gov.ph/">FDA Philippines</a></td><td>Drug approval data for the Philippines</td></tr>
</tbody>
</table>
...
| Regulatory authority | FDA Philippines |
...
- **GitHub Issues**: <https://github.com/yao-care/PhTxGNN/issues>
