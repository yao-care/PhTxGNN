...
description: "How PhTxGNN produces and validates predictions: TxGNN knowledge graph prediction, evidence collection, L1-L5 grading, and decision recommendations."
---
...
<p class="key-answer" data-question="How does PhTxGNN produce its predictions?">
...
<li><strong>Evidence collection</strong>: for each predicted pair, evidence is gathered from ClinicalTrials.gov, PubMed, DrugBank and FDA Philippines.</li>
...
Drug approval data for the Philippines comes from FDA Philippines. Ingredient names are mapped to the
