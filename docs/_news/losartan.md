...
parent: Health News
nav_exclude: true
description: "Health news related to Losartan. Original indication: . 8 predicted indications."
...
<p class="key-answer" data-question="What news is there about Losartan?">
<strong>Losartan</strong> currently has <strong>0 news articles</strong>, with 8 predicted indications.
</p>

<div class="key-takeaway">
This page combines the AI-predicted indications for Losartan with the latest health news. Indications highlighted in orange have recent news coverage.
</div>
...
<p><a href="{{ '/drugs/losartan/' | relative_url }}">View full drug report →</a></p>
</div>
